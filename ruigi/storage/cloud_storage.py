# Client abs
# Save from file / Save from memory IO
# uploadfileObj, uploadFile, remove, exists
...
class CloudStorage:
    # TODO: How can we make Cloud Storages dependent on this class?

    def __init__(self, parent_folder='.', *args, **kwargs):
        self.client = None
        self.bucket = None
